...
syntax match httpfileKeywords "\v^%(GET|POST|HEAD|PUT|DELETE|RSOCKET|RPC|FNF|STREAM|METADATA_PUSH|GRPC|GRAPHQL|GRAPHQLWS|GRAPHQLWSS|DUBBO|SOFA|TARPC|MSGPACK|NVIM|JSONRPC|THRIFT|ZEROREQ|MAIL|ALIYUN|MEMCACHE|AWS|AWSPOST|AWSDELETE|AWSPUT|PUB|SUB|RSET|HMSET|EVAL|SSH)\s"
