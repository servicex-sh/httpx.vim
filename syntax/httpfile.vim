...
syntax match httpfileKeywords "\v^%(GET|POST|HEAD|PUT|DELETE|WEBSOCKET|RSOCKET|RPC|FNF|STREAM|METADATA_PUSH|GRPC|GRAPHQL|DUBBO|SOFA|TARPC|MSGPACK|NVIM|JSONRPC|THRIFT|ZEROREQ|MAIL|ALIYUN|MEMCACHE|AWS|AWSPOST|AWSDELETE|AWSPUT|PUB|SUB|RSET|HMSET|EVAL|LOAD|SSH|REST|CHATGPT)\s"
